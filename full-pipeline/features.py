...
DETAILS = [
    ...
    },
    {
        ...
        "description": "returns a json with keys as destinations like lines or stations and values as a list of strings containing the latest distruptions. if a location is not specified in the key, it may be located in the value. all distruptions with unspecified keys are stored in a list located at 'contained in details' in the json.",
        "parameters": {
            "type": "object",
            "properties": {}
        }
...
def getDistruptions():
    ...
    return {'contained in details': ['One escalator on Platform 6/7 at Flinders Street Station will be closed from 11pm Sunday 12 November to 12pm Wednesday 29 November 2023, due to station works. To access Platform 6/7, please use the adjacent stairs or lift located opposite Platform 2/3. For your safety, please observe any signage and instructions in place during this time.'], 'Hurstbridge Line': [' Buses replacing trains on Friday 24 November 2023'], 'Mernda Line': [' Buses replacing trains on Friday 24 November 2023'], 'Parkdale Station': [' Station closure from 11.30pm Saturday 21 October 2023 to mid-2024'], 'Sunbury Line': [' Buses replace trains from 11.30pm Thursday 23 November to last service Sunday 26 November 2023'], 'Cranbourne and Pakenham lines': [' Buses replacing trains from first service Friday 24 November to last service Sunday 26 November 2023'], 'Pakenham Line': [' Buses replace trains between Dandenong and Pakenham from 9.30pm Friday 24 November to 9.30pm Sunday 26 November 2023'], 'Belgrave and Lilydale lines': [' Buses replace trains on select sections from late January 2024'], 'Frankston Line stations': [' Temporary car park closures, platform closures, and changes to pedestrian access until mid-2024'], 'Cranbourne and Pakenham line stations': [' Temporary car park closures and changes to pedestrian access until 2024'], 'Hurstbridge Line stations': [' Temporary car park closures and pedestrian access changes from January 2021 until further notice'], 'Belgrave Station': [' Temporary car park closures from 4am Wednesday 23 March 2022 to Sunday 31 December 2023'], 'Flinders Street Station': [' Temporary pedestrian access changes from Saturday 30 April 2022 to 2024'], 'Albion and Sunshine stations': [' Temporary car park closures at select times from January 15 2023 to early February 2025'], 'Croydon Station': [' Temporary car park closures and bus interchange relocation from Tuesday 28 March to 2025', ' Temporary pedestrian access changes from Thursday 9 November to late November 2023'], 'Ringwood East Station': [' Temporary car park closure and pedestrian access changes from Monday 29 May 2023 until 2025', ' Permanent pedestrian access changes from Wednesday 18 October 2023'], 'Keon Park Station': [' Temporary car park closures from Monday 5 June 2023 to 2025'], 'Sunbury Station': [' Temporary car park closures from 20 June 2023 until late 2024'], 'Bayswater Station': [' Temporary car park closures from Monday 10 July 2023 to Sunday 31 March 2024', ' Temporary pedestrian access changes from Tuesday 24 October to March 2024'], 'Craigieburn Station': [' Temporary car space closures from mid-August 2023 until further notice'], 'Parliament Station': [' Temporary pedestrian access changes from June 2022 to late 2023'], 'Merinda Park Station': [' Temporary car park closures from late-September 2023 to mid-January 2024'], 'Boronia Station': [' Temporary car space closures from Monday 13 November to Friday 24 November 2023'], 'Pakenham Station': [' Station closure from 10pm Friday 24 November to 3am Monday 11 December 2023'], 'Merlynston Station': [' Car Park opening from Friday 17 November 2023'], 'The 10': ['45pm Flinders Street to Craigieburn service will terminate at Essendon due to a vandalised train'], 'Union Station': [' Car park and bus stop openings from late 2023']}    # return webscraper.ptv_disruptions(trip_type)
...
OPTIONS = {'getStartingLocation': getStartingLocation, 
           ...
           'getDistruptions': getDistruptions,
           'getMelbourneEvents': getMelbourneEvents} 
